          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-accent-foreground/80 text-sm leading-relaxed">
              ...
              <li className="flex items-center gap-3">
                ...
                <div className="text-sm">
                  <a
                    ...
                    className="text-accent-foreground/80 hover:text-white transition-colors block"
                  >
                    +91 98105 04174
                  </a>
                  <a
              ...
              <li className="flex items-center gap-3">
                <Mail className="w-5 h-5 text-accent-foreground shrink-0" />
                <a
            ...
            <p className="text-accent-foreground/60 text-xs mt-6">
